--[[
    ...
    Changes:
    - Added IsPrimaryInput helper (MouseButton1 + Touch)
    - MouseButton1 comparisons extended to include Touch
    - MouseMovement comparisons extended to include Touch
    - Compatible with PC + Mobile

    NOTE:
    - Hovering() still uses mouse-style logic; for full mobile UX,
      consider migrating to InputService:GetMouseLocation everywhere.
]]

local function IsPrimaryInput(input)
    return IsPrimaryInput(input)
